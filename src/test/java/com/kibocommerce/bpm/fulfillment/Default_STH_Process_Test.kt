...
class Default_STH_Process_Test : JbpmJUnitBaseTestCase(true, false) {
    private var kieSession: KieSession? = null
    private var taskService: TaskService? = null

    @Before
    fun init() {
        createRuntimeManager("com/kibocommerce/bpm/fulfillment/Default_STH_Process.bpmn")
    ...
    private fun createProcess(): WorkflowProcessInstance {
        ...
        val processInstance = kieSession!!.startProcess("Default_STH_Process", processParam)
    ...
    companion object {
        private val logger = LoggerFactory.getLogger(Default_STH_Process_Test::class.java)
    }
}